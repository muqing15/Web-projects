            ...
            <div class="row">
                <div id="main-content" class="col-2-3">
                    <div class="contact">
                        <h2>注册</h2>
                        <div id="contact_form">
                            <form name="form1" id="ff" method="post" action="http://47.95.5.140:8080/register" accept-charset="UTF-8" >
                                <!-- <label>
                                <span>姓名</span>
                                ...
                                <label float="right">
									<span style="float:inherit">
										<a href="http://47.95.5.140:8080/to_phone_register">用手机注册></a>
									</span>
                                </label>
        ...
        $(document).ready(function() {
            $(function () {
                ...
                $("#getCode").click(function () {
                    $.ajax({
                        url: "http://47.95.5.140:8080/send_mail?email"+$("#email").val(),
                        data: {
                            // "phone": $("#phone").val()
                        },
                        type: "post",
            ...
            $("#validate").click(function () {
                $.ajax({
                    url: "http://47.95.5.140:8080/verify_mail",
                    data: {
                        "code": $("#code").val()
                    },
                    type: "post",
