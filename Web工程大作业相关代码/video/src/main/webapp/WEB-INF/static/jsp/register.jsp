			...
			<div class="row">
				<div id="main-content" class="col-2-3">
					<div class="contact">
						<h2>注册</h2>
						<div id="contact_form">
							<form name="form1" id="ff" method="post" action="http://47.95.5.140:8080/register">
								<label>
									<span>用户名</span>
									...
									<%--<script type="text/javascript">--%>
                                        <%--$(function () {--%>
                                            ...
                                            <%--$("#getCode").click(function () {--%>
                                                <%--$.ajax({--%>
                                                    <%--url: "http://47.95.5.140:8080/sms_verify?phone"+$("#phone").val(),--%>
                                                    <%--data: {--%>
                                                        <%--// "phone": $("#phone").val()--%>
                                                    <%--},--%>
                                                    <%--type: "post",--%>
								...
								<label float="right">
									<span style="float:inherit">
										<a href="http://47.95.5.140:8080/to_mail_register">用邮箱注册></a>
									</span>
								</label>
	...
	<script type="text/javascript">
        $(document).ready(function() {
            $(function () {
                ...
                $("#validate").click(function () {
                    $.ajax({
                        url: "http://47.95.5.140:8080/sms_2verify?code" + $("#code").val(),
                        data: {
                            "code": $("#code").val()
                        },
                        type: "post",
